...
output-contract items this branch found, and a ticket in the source repo holds the phase 9
...
keep seating OpenRouter, and it still described the source repo ticket as unfiled.
