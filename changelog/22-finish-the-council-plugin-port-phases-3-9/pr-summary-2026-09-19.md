...
Closes the three-branch arc that moved `council` out of `cjus-dev` and into this repo. #9
...
repo boundary on #14; its cjus-dev half is [cjus/cjus-dev#89](https://github.com/cjus/cjus-dev/issues/89).
