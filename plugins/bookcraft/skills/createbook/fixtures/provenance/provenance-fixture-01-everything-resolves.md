...
A mark may name an item the source defines.
<!-- src: handbook Q3 -->

A mark may say the book supplied the claim itself, in which case no source is searched.
<!-- src: fill (the whole paragraph) -->

A mark may point back into this book, at a chapter it has.
<!-- src: chapter 2; fill (the pointer) -->

A mark may carry a prefix book.json declares as unsourced.
<!-- src: measured 2026-09-13, on this machine -->

A mark may cite a step the source numbers.
<!-- src: handbook step 2 -->

A mark may cite a heading with an item number the source defines under it.
<!-- src: handbook § Requirements 2 -->
