...
| | |
|---|---|
| **This chapter** | The four callout labels, spelled exactly as the checker matches them. Reference matter for the guide fixture. |
| **Act on this** | Copy a label from this table rather than typing it, since the match is literal. |
...
| Label | For |
|---|---|
| `> **Decide.**` | A choice the reader has to make, and what turns on it. |
