...
| Argument | Meaning |
|---|---|
| First (required) | What the book is: subject, and where useful the reader and the angle |
...
It plans the outline first and stops for your approval before narrating anything.
...
`skills/createbook/fixtures/` holds two small books that exercise the checkers, and they are the fastest way to see what a failure looks like:
...
skills/
  createbook/
    ...
    fixtures/                       two books that exercise the checkers
  makebook/
    SKILL.md                        the procedure
